...
<form action="{{ route('settings') }}" method="post">
    ...
    <div class="form-group">
        <x-form-input label="SMTP Password" name="config[mail.mailers.smtp.password]"  :value="config('mail.mailers.smtp.password')" />
    </div>

    <div class="form-group">
        <button type="submit" class="btn btn-primary">Save</button>
        <a href="{{ route('clearCache') }}" class="btn btn-dark">Clear Cache</a>
    </div>
