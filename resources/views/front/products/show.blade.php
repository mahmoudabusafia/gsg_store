                    ...
                    <div class="ps-product__thumbnail">
                        <div class="ps-product__preview">
                            <div class="ps-product__variants">
                                <div class="item"><img src="{{ asset('assets/images/shoe-detail/1.jpg') }}" alt=""></div>
                                <div class="item"><img src="{{ asset('assets/images/shoe-detail/2.jpg') }}" alt=""></div>
                                <div class="item"><img src="{{ asset('assets/images/shoe-detail/3.jpg') }}" alt=""></div>
                                <div class="item"><img src="{{ asset('assets/images/shoe-detail/3.jpg') }}" alt=""></div>
                                <div class="item"><img src="{{ asset('assets/images/shoe-detail/3.jpg') }}" alt=""></div>
                            </div><a class="popup-youtube ps-product__video" href="http://www.youtube.com/watch?v=0O2aH4XLbto"><img src="{{ asset('assets/images/shoe-detail/1.jpg') }}" alt=""><i class="fa fa-play"></i></a>
                        </div>
                        <div class="ps-product__image">
                            <div class="item"><img class="zoom" src="{{ asset('assets/images/shoe-detail/1.jpg') }}" alt="" data-zoom-image="images/shoe-detail/1.jpg"></div>
                            <div class="item"><img class="zoom" src="{{ asset('assets/images/shoe-detail/2.jpg') }}" alt="" data-zoom-image="images/shoe-detail/2.jpg"></div>
                            <div class="item"><img class="zoom" src="{{ asset('assets/images/shoe-detail/3.jpg') }}" alt="" data-zoom-image="i{{ asset('assets/mages/shoe-detail/3.jpg') }}"></div>
                        </div>
                    </div>
