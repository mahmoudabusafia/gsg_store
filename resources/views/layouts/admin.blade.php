...
<body class="hold-transition sidebar-mini">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            ...
                            <div class="media">
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        <button style="border: none; background-color: white; width: 100%;">Logout</button> 
                                    </h3>
                                </div>
                            </div>
                            <!-- Message End -->
                        ...
                        <a href="#" class="dropdown-item dropdown-footer">See All Setting</a>
                    </div>
                </li>
    ...
    <script src="{{ asset('build/assets/app.23d43d1d.js') }}"></script>  -->
